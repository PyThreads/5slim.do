...
import { IBrand } from "../../../../../../api/src/interfaces";
...
export default function CreateBrandForm({ brandToEdit, onClose }: { brandToEdit?: IBrand | null, onClose: Function }) {
