        ...
        <Box padding={0} bgcolor={"#FFFFFF"} borderRadius={"12px"} >
            ...
            <Grid container item xs={12} justifyContent={"space-between"} alignItems={"center"} spacing={1}>
                ...
                <Grid item xs={12} md={5} lg={5} >
                    <Typography fontFamily={inter.style.fontFamily} fontSize={{ xs: 13, sm: 16, md: 16 }} color={"#45464E"}>Categorías</Typography>
                </Grid>
                    ...
                    <Table size="small" aria-label="a dense table" sx={styles.table}>
                        <TableHead sx={{ padding: 0 }}>
                            ...
                            >
                                ...
                                <TableCell width={60}>
                                    <Typography fontFamily={inter.style.fontFamily} fontSize={"14px"} fontWeight={"400"} color={"#2C2D33"}>
                                        Icono
                                    </Typography>
                                </TableCell>
                            ...
                            {rows.map((row: ICategory) => (
                                ...
                                >
                                    ...
                                    <TableCell align="left" sx={styles.tableCellBody}>
                                        {row.icon ? (
                                            <Box width={32} height={32} position="relative" borderRadius="4px" overflow="hidden">
                                                <Image
                                                    src={row.icon}
                                                    alt={row.description}
                                                    fill
                                            ...
                                            <Box width={32} height={32} bgcolor="#f5f5f5" borderRadius="4px" display="flex" alignItems="center" justifyContent="center">
                                                <Typography fontSize="12px" color="#999">N/A</Typography>
                                            </Box>
                                        )}
                                    </TableCell>
                            ...
                            <CardContent sx={styles.mobileCardContent}>
                                <Box display="flex" justifyContent="space-between" alignItems="flex-start" mb={1}>
                                    <Box display="flex" alignItems="center" gap={1}>
                                        {row.icon ? (
                                            <Box width={24} height={24} position="relative" borderRadius="4px" overflow="hidden">
                                                <Image
                                                    src={row.icon}
                                                    alt={row.description}
                                                    fill
                                            ...
                                            <Box width={24} height={24} bgcolor="#f5f5f5" borderRadius="4px" display="flex" alignItems="center" justifyContent="center">
                                                <Typography fontSize="10px" color="#999">N/A</Typography>
                                            </Box>
                                        )}
