...
export default function TableEmployeesList(
    {
        setFilters,
        rows,
        currentPage,
        ...
        <Box padding={"22px 21px"} bgcolor={"#FFFFFF"} borderRadius={"12px"} >
            ...
            <Grid container item xs={12} justifyContent={"space-between"} alignItems={"center"} spacing={1}>
                ...
                <Grid item xs={12} md={5} lg={5} >
                    <Typography fontFamily={inter.style.fontFamily} fontSize={{ xs: 13, sm: 16, md: 16 }} color={"#45464E"}>Empleados</Typography>
                </Grid>
                                ...
                                >
                                    ...
                                    <TableCell align="left" sx={styles.tableCellBody}>
                                        <Typography fontFamily={inter.style.fontFamily} fontWeight={"400"} color={"#519C66"} fontSize={"12px"}
                                            borderRadius={"8px"} bgcolor={"#32936F29"} width={"fit-content"} padding={"4px 4px"} textAlign={"center"}
                                        >
                                            Activo
                                        </Typography>
                                    </TableCell>
