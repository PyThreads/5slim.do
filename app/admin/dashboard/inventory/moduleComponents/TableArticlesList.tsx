        ...
        <Box padding={"22px 21px"} bgcolor={"#FFFFFF"} borderRadius={"12px"} >
            ...
            <Grid container spacing={2} alignItems="center">
                ...
                <Grid item xs={12} md={4}>
                    <Typography fontFamily={inter.style.fontFamily} fontSize={{ xs: 13, sm: 16, md: 16 }} color={"#45464E"}>Artículos</Typography>
                </Grid>
                        ...
                        <TableHead sx={{ padding: 0 }}>
                            ...
                            >
                                ...
                                <TableCell align="center" width="12%">
                                    <Box display={"flex"} alignItems={"center"} justifyContent={"center"}>
                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"12px"} fontWeight={"400"} color={"#2C2D33"} mr={1}>
                                            Alerta
                                        </Typography>
                                        <SortTableIcon filled />
                                    </Box>
                                ...
                                >
                                    ...
                                    <TableCell align="center" sx={styles.tableCellBody}>
                                        {articleService.isLowStock(row) && (
                                            <Typography fontFamily={inter.style.fontFamily} fontWeight={"400"} color={"#CC5F5F"} fontSize={"12px"}
