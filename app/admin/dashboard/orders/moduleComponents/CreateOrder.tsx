        ...
        >
            <Grid p={0} m={0} xs={12}>
                <Grid item container height={10} justifyContent={"space-between"}>
                    <Typography fontFamily={inter.style.fontFamily} fontSize={"20px"} fontWeight={400}>Nueva Orden</Typography>
                ...
                <Grid container spacing={2} xs={12} mt={2}>
                    ...
                    <Grid item xs={12} md={12} lg={6}>
                        ...
                        <Grid xs={12} >
                            <Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} color={"#8B8D97"} fontWeight={500}>Detalles De La Orden</Typography>
                        </Grid>
                                        ...
                                        renderOption={(props: any, option: any) => {
                                            ...
                                            return (
                                                <Box key={key} display="flex" alignItems="center" {...rest}>
                                                    ...
                                                    <Typography fontFamily={ inter.style.fontFamily} fontSize="14px" color="#8B8D97">
                                                        {option.fullClient}
                                                    </Typography>
                                                </Box>
                                            );
                        ...
                        <Grid item xs={12} mt={2}>
                            <Typography fontFamily={inter.style.fontFamily} fontSize={"14px"} color={"#53545C"} fontWeight={400} mb={"8px"}>Fecha De La Orden</Typography>
                        ...
                        <Grid item xs={12} mt={2} >
                            <Typography fontFamily={inter.style.fontFamily} fontSize={"14px"} color={"#53545C"} fontWeight={400} mb={"8px"}>Estado</Typography>
                        ...
                        <Grid item xs={12} mt={2} >
                            <Typography fontFamily={inter.style.fontFamily} fontSize={"14px"} color={"#53545C"} fontWeight={400} mb={"8px"}>Tipo de Orden</Typography>
                        ...
                        <Grid item xs={12} mt={2}>
                            <Typography fontFamily={inter.style.fontFamily} fontSize={"14px"} color={"#53545C"} fontWeight={400} mb={"8px"}>Envío</Typography>
                    ...
                    <Grid item xs={12} md={12} lg={6} >
                        ...
                        <Grid xs={12}>
                            <Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} color={"#8B8D97"} fontWeight={500}>Artículos</Typography>
                        </Grid>
                        ...
                        <Grid item xs={12} mt={3} >
                            ...
                            <Grid item xs={12} mt={3} sx={{ ...style.hideScroll }} >
                                            ...
                                            <Box display={"flex"} mt={1} p={1} border={"1px solid #E1E2E9"} borderRadius={"8px"}>
                                                ...
                                                <Box ml={"14px"} width={"100%"}>
                                                    <Box display={"flex"} justifyContent={"space-between"} alignItems={"flex-start"} mb={1}>
                                                        <Box flex={1}>
                                                            <Tooltip title={item.description} placement="top" arrow>
                                                                <Typography fontFamily={inter.style.fontFamily} fontSize={"12px"} color={"#000"} fontWeight={500}>
                                                            ...
                                                            <Box display="flex" flexDirection="column" gap={0.2} mt={0.5}>
                                                                <Typography fontFamily={inter.style.fontFamily} fontSize={"10px"} color={"#8B8D97"} fontWeight={400}>CÓDIGO: {item._id}</Typography>
                                                                {item.externalCode && (
                                                                    <Typography fontFamily={inter.style.fontFamily} fontSize={"10px"} color={"#8B8D97"} fontWeight={400}>CÓDIGO EXTERNO: {item.externalCode}</Typography>
                                                                )}
                                                            </Box>
                                                        </Box>
                                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"10px"} color={"#CC5F5F"} fontWeight={500} sx={{ cursor: "pointer" }}
                                                            onClick={() => {
                                                                setOrder({
                                                                    ...order,
                                                    ...
                                                    <Box display={"flex"} justifyContent={"space-between"} alignItems={"center"} mb={1}>
                                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"11px"} color={"#8B8D97"} fontWeight={400}>
                                                            {baseService.dominicanNumberFormat(item.variant.sellingPrice)}
                                                        </Typography>
                                                        <Box display={"flex"} alignItems={"center"} gap={1}>
                                                            <Typography fontFamily={inter.style.fontFamily} fontSize={"10px"} color={"#8B8D97"} sx={{ cursor: "pointer" }}
                                                                onClick={() => {
                                                            ...
                                                            <Typography fontFamily={inter.style.fontFamily} fontSize={"12px"} color={"#000"} fontWeight={500} minWidth={"20px"} textAlign={"center"}>
                                                                {item.variant.stock}
                                                            </Typography>
                                                            <Typography fontFamily={inter.style.fontFamily} fontSize={"10px"} color={"#8B8D97"} sx={{ cursor: "pointer" }}
                                                                onClick={() => {
                                                    ...
                                                    <Box display={"flex"} justifyContent={"space-between"} alignItems={"center"}>
                                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"10px"} color={"#5570F1"} fontWeight={500} sx={{ cursor: "pointer" }}
                                                            onClick={() => {
                                            ...
                                            <Box borderBottom={"1px solid #00000007"} paddingBottom={"5px"} mt={1} width={"100%"}>
                                                {item.orderDiscount && (
                                                    <Box display={"flex"} justifyContent={"space-between"} mb={0.5}>
                                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"12px"} color={"#FF9800"} fontWeight={500}>
                                                ...
                                                <Box display={"flex"} justifyContent={"space-between"}>
                                                    <Typography fontFamily={inter.style.fontFamily} fontSize={"15px"} color={"#8B8D97"} fontWeight={500}>Sub-total</Typography>
                                                    <Typography fontFamily={inter.style.fontFamily} fontSize={"15px"} color={"#33343A"} fontWeight={500}>
                                                        {baseService.dominicanNumberFormat(
                                                            item.orderDiscount 
...

                                {
                                    ...
                                    <Box height={"100%"} display={"flex"} justifyContent={"center"} alignItems={"center"} flexDirection={"column"}>
                                        ...
                                        <Typography fontFamily={inter.style.fontFamily} sx={{ fontSize: { xs: "14px", sm: "20px" } }} color={"#000"} fontWeight={500} mt={"40px"}>
                                            Agregar Artículos
                                        </Typography>

                                        <Typography fontFamily={inter.style.fontFamily} sx={{ fontSize: { xs: "11px", sm: "13px" } }} textAlign={"center"} color={"#8B8D97"} fontWeight={500} mt={"12px"}>
                            ...
                            </Grid>
                            {
                                ...
                                <Grid item xs={12} mt={3}>
                                    <Box display={"flex"} justifyContent={"space-between"}>
                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} color={"#8B8D97"} fontWeight={500} >Descuento</Typography>
                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"12px"} color={"#33343A"} fontWeight={500} >{ordersService.dominicanNumberFormat(totals.discount!)}</Typography>
                                    </Box>

                                    <Box display={"flex"} justifyContent={"space-between"}>
                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} color={"#8B8D97"} fontWeight={500} >Subtotal</Typography>
                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"12px"} color={"#33343A"} fontWeight={500} >{ordersService.dominicanNumberFormat(totals.subTotal)}</Typography>
                                    </Box>

                                    <Box display={"flex"} justifyContent={"space-between"}>
                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} color={"#8B8D97"} fontWeight={500} >Total</Typography>
                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"12px"} color={"#33343A"} fontWeight={500} >{ordersService.dominicanNumberFormat(totals.total)}</Typography>
                                    </Box>
                                </Grid>
                            }
                        </Grid>
                            ...
                            >
                                ...
                                <Box ml={2} flex={1} display={"flex"} flexDirection={"column"} justifyContent={"space-between"}>
                                    <Box>
                                        ...
                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"14px"} color={"#059669"} fontWeight={400} mt={0.5}>
                                            {baseService.dominicanNumberFormat(item.variant.sellingPrice)}
                                        </Typography>
                                    </Box>
                                    ...
                                    <Box display={"flex"} justifyContent={"space-between"} alignItems={"flex-end"} mt={1}>
                                        <Box>
                                            <Typography fontFamily={inter.style.fontFamily} fontSize={"10px"} color={"#6B7280"} fontWeight={400}>
                                                CÓDIGO: {item._id}
                                            </Typography>
                                            {item.externalCode && (
                                                <Typography fontFamily={inter.style.fontFamily} fontSize={"10px"} color={"#6B7280"} fontWeight={400}>
            ...
            <CustomModal open={openModalArticle} borderRadius={"8px"}>
                <Box padding={"10px 10px"} minHeight={200} maxHeight={"80vh"}>
                    <Grid item container height={10} justifyContent={"space-between"}>
                        <Typography fontFamily={inter.style.fontFamily} fontSize={"20px"} fontWeight={400}>Seleccionar Variante</Typography>
                        <CloseIcon sx={{ backgroundColor: "#FFF2E2", width: 32, height: 32, borderRadius: "8px", cursor: "pointer", padding: "5px", color: "#000" }}
                            onClick={() => {
                    ...
                    <TableContainer component={Paper} sx={{
                        ...
                        <Table size="small" aria-label="a dense table">
                            ...
                            <TableHead>
                                <TableRow>
                                    <TableCell></TableCell>
                                    <TableCell><Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} textAlign={"center"}>Estado</Typography></TableCell>
                                    <TableCell><Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} textAlign={"center"}>Talla</Typography></TableCell>
                                    <TableCell><Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} textAlign={"center"}>Disponibilidad</Typography></TableCell>
                                    <TableCell><Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} textAlign={"center"}>Stock</Typography></TableCell>
                                    <TableCell align="left"> <Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} textAlign={"center"}>Costo</Typography></TableCell>
                                    <TableCell align="left">  <Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} textAlign={"center"}>Venta</Typography></TableCell>
                                    <TableCell align="left">  <Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} textAlign={"center"}>Ganancia</Typography></TableCell>
                                </TableRow>
                            </TableHead>
            ...
            <CustomModal open={openCreateClientModal} borderRadius={"8px"}>
                <Box padding={"20px"} minHeight={200} maxHeight={"80vh"} sx={{ overflowY: 'auto' }}>
                    <Grid item container justifyContent={"space-between"} alignItems={"center"} mb={2}>
                        <Typography fontFamily={inter.style.fontFamily} fontSize={"20px"} fontWeight={400}>Crear Cliente</Typography>
                        <CloseIcon 
                            sx={{ 
