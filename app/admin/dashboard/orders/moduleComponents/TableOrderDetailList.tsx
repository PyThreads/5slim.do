    ...
    return (
        <Box padding={"22px 21px"} bgcolor={"#FFFFFF"} borderRadius={"12px"} >
            ...
            <Grid container item xs={12} justifyContent={"space-between"} alignItems={"center"}>
                ...
                <Typography fontFamily={inter.style.fontFamily} fontSize={"16px"} fontWeight={"500"} color="#45464E">Articulos
                    <Typography fontFamily={inter.style.fontFamily} component={"span"} ml={0.5} color={"#5570f1"}>{order.articles.length}</Typography>
                </Typography>
                        ...
                        <TableBody sx={{ borderBottom: "1px solid #E1E2E9" }}>
                            {order.articles.map((row: IArticleCart, index: number) => (
                                ...
                                >
                                        ...
                                        <Box display={"flex"} alignItems={"center"}>
                                            ...
                                            >
                                                ...
                                                <Box display="flex" flexDirection="column" gap={0.2} mt={0.5}>
                                                    <Typography fontFamily={inter.style.fontFamily} fontSize={"10px"} color={"#8B8D97"} fontWeight={400}>CÓDIGO: {row._id}</Typography>
                                                    {row.externalCode && (
                                                        <Typography fontFamily={inter.style.fontFamily} fontSize={"10px"} color={"#8B8D97"} fontWeight={400}>CÓDIGO EXTERNO: {row.externalCode}</Typography>
                                                    )}
                                                </Box>
                                            </Box>
                                        </Box>
                                    ...
                                    <TableCell align="left" sx={styles.tableCellBody}>
                                        <Typography fontFamily={inter.style.fontFamily} fontWeight={"400"} color={"#FF9800"} fontSize={"12px"}>
                                            {row.orderDiscount 
                            ...
                            {order.total.discount > 0 && (
                                <TableRow key="subtotal-row">
                                    ...
                                    <TableCell align="left" sx={styles.tableCellBody} />
                                    <TableCell align="left" sx={styles.tableCellBody}>
                                        <Typography fontFamily={inter.style.fontFamily} fontWeight={"400"} color={"#8B8D97"} fontSize={"14px"}>
                                            Subtotal:
                                        </Typography>
                                    </TableCell>
                                    <TableCell align="left" sx={styles.tableCellBody}>
                            ...
                            {order.total.discount > 0 && (
                                <TableRow key="discount-row">
                                    ...
                                    <TableCell align="left" sx={styles.tableCellBody} />
                                    <TableCell align="left" sx={styles.tableCellBody}>
                                        <Typography fontFamily={inter.style.fontFamily} fontWeight={"400"} color={"#FF9800"} fontSize={"14px"}>
                                            Descuento:
                                        </Typography>
                                    </TableCell>
                                    <TableCell align="left" sx={styles.tableCellBody}>
                            ...
                            <TableRow key="total-row">
                                ...
                                <TableCell align="left" sx={styles.tableCellBody} />
                                <TableCell align="left" sx={styles.tableCellBody}>
                                    <Typography fontFamily={inter.style.fontFamily} fontWeight={"600"} color={"#2C2D33"} fontSize={"16px"}>
                                        Total:
                                    </Typography>
                                </TableCell>
                                <TableCell align="left" sx={styles.tableCellBody}>
                ...
                <Box sx={{ display: { xs: 'block', md: 'none' } }}>
                    ...
                    <Card sx={{ ...styles.mobileCard, backgroundColor: '#F8F9FF', border: '1px solid #5570F1' }}>
                        <CardContent sx={styles.mobileCardContent}>
                            ...
                            <Box display="flex" justifyContent="space-between">
                                <Typography sx={{ ...styles.mobileCardLabel, fontWeight: 400, color: '#2C2D33' }}>Total General:</Typography>
                                <Typography sx={{ ...styles.mobileCardValue, fontWeight: 400, color: '#2C2D33' }}>{baseService.dominicanNumberFormat(order.total.total)}</Typography>
                            </Box>
                        </CardContent>
                    </Card>
                </Box>
