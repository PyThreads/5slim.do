...
export default function CreateUserForm({ valuesToEdit = {}, onClose }: CreateUserFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <Grid container>
                <Typography fontFamily={"Inter"} fontSize={16} color={"#8B8D97"} marginTop={"28px"}>Información del usuario</Typography>
                ...
                <Grid item xs={12} mt="28px">
                    <FormControlLabel
                        ...
                        label={
                            <Typography fontFamily="Inter" fontSize={16} color="#8B8D97">
                                Usuario Activo
                            </Typography>
                        }
                    />
