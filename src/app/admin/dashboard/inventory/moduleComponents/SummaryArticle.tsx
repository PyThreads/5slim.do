                    ...
                    <Grid item container spacing={1} mt={"32px"}>
                        ...
                        <Grid item xs={12} sm={7}>
                            <Box padding={0} margin={0}>
                                <Typography fontFamily={"Inter"} color={"#FFF"} fontSize={"18px"} fontWeight={400} >Todos</Typography>
                                <Box sx={{ cursor: "pointer" }}>
                                    <Grid item container alignItems={"center"} >
                                        <Typography fontFamily={"Inter"} color={"#FFF"} fontSize={"25px"} fontWeight={500} >1,250 </Typography>
                                    </Grid>
                                </Box>
                            </Box>
                        </Grid>
                        ...
                        <Grid item xs={12} sm={4}>
                            <Box padding={0} margin={0}>
                                <Typography fontFamily={"Inter"} color={"#FFF"} fontSize={"18px"} fontWeight={400} >Activos </Typography>
                                <Box sx={{ cursor: "pointer" }}>
                                    <Grid item container alignItems={"center"} >
                                        <Typography fontFamily={"Inter"} color={"#FFF"} fontSize={"25px"} fontWeight={500} >1,250 </Typography>
            ...
            <Grid container item xs={12} md={6} >
                <Box borderRadius={"12px"} bgcolor={"#FFFFFF"} padding={"11px 15px"} minHeight={"145px"} margin={0} width={"100%"} >
                    ...
                    <Grid item container spacing={1} mt={"32px"}>
                        ...
                        <Grid item xs={6} sm={4}>
                            <Box padding={0} margin={0}>
                                <Typography fontFamily={"Inter"} color={"#BEC0CA"} fontSize={"18px"} fontWeight={400} >Alerta Stock</Typography>
                                <Box sx={{ cursor: "pointer" }}>
                                    <Grid item container alignItems={"center"} >
                        ...
                        <Grid item xs={6} sm={4}>
                            <Box padding={0} margin={0}>
                                <Typography fontFamily={"Inter"} color={"#BEC0CA"} fontSize={"18px"} fontWeight={500} >Agotados</Typography>
                                <Box sx={{ cursor: "pointer" }}>
                                    <Grid item container alignItems={"center"} >
                        ...
                        <Grid item xs={6} sm={4}>
                            <Box padding={0} margin={0}>
                                <Typography fontFamily={"Inter"} color={"#BEC0CA"} fontSize={"18px"} fontWeight={500} >Vendidos hoy</Typography>
                                <Box sx={{ cursor: "pointer" }}>
                                    <Grid item container alignItems={"center"} >
