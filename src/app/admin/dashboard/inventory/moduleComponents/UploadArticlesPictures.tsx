        ...
        <Grid container item xs={12} md={4}  >
            <Grid container item xs={12} >
                <Box borderRadius={"12px"} padding={"25px"} minHeight={"145px"} margin={0} width={"100%"} bgcolor={"#FFF"} >
                                    ...
                                    (
                                        ...
                                        >
                                            ...
                                            <Box display={"flex"} justifyContent={"center"} alignItems={"center"} mt={"12px"}>
                                                ...
                                                <Typography fontFamily={"Inter"} fontSize={"14px"} color={"#8B8D97"} fontWeight={"400"} margin={"0px 20px"}>
                    ...
                    <Typography fontFamily={"Inter"} fontSize={"17px"} color={"#45464E"} fontWeight={"400"} mt={"12px"} >
                        Fotos adicionales
                    </Typography>
