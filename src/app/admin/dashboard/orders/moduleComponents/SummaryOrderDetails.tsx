...
import { ShoppingBagIcon, CustomersIcon, ShoppingCartIcon, UserIconOrder, LocationPinIcon, CreditCardIcon } from "../../../../../../components/icons/Svg";
                ...
                <Grid container item xs={12} sm={6}>
                    <Box borderRadius={"12px"} padding={"11px 15px"} minHeight={"145px"} margin={0} width={"100%"} bgcolor={"#FFF"} >
                        ...
                        <Grid container item xs={12} justifyContent={"space-between"}>
                            ...
                            <Grid xs={8}>
                                <Grid item>
                                    <Typography fontFamily={"Inter"} color={"#8B8D97"} fontSize={"12px"} fontWeight={300} mt={0.1} >{order.client.fullName}</Typography>
                                    <Typography fontFamily={"Inter"} color={"#8B8D97"} fontSize={"12px"} fontWeight={300} mt={0.5} >
                                        Cliente desde
                                        <Typography component={"span"} fontFamily={"Inter"} color={"#45464E"} fontSize={"12px"} fontWeight={300} display={"inline"} ml={0.5}>{baseService.formatLetters(order.client.createdDate)}</Typography>
                                    </Typography>
                                </Grid>
                            </Grid>
                        ...
                        <Grid item container spacing={1} mt={"32px"}>
                                ...
                                <Box padding={0} margin={0}>
                                    ...
                                    <Box >
                                        <Grid item container alignItems={"center"} >
                                            <Typography fontFamily={"Inter"} color={"#45464E"} fontSize={"12px"} fontWeight={500} >{order.client.address.phone}</Typography>
                                        </Grid>
                                    </Box>
                                </Box>
                            </Grid>
                            ...
                            <Grid item xs={6} >
                                <Box padding={0} margin={0}>
                                    ...
                                    <Box >
                                        <Grid item container alignItems={"center"} >
                                            <Typography fontFamily={"Inter"} color={"#45464E"} fontSize={"12px"} fontWeight={500} >{order.client.email}</Typography>
                                        </Grid>
                                    </Box>
                                </Box>
                            </Grid>
                        ...
                        <Grid item container spacing={1} mt={"32px"}>
                            ...
                            <Grid item xs={12}>
                                <Box padding={0} margin={0}>
                                    ...
                                    <Box >
                                        <Grid item container alignItems={"center"} >
                                            <Typography fontFamily={"Inter"} color={"#45464E"} fontSize={"12px"} fontWeight={500} >{baseService.fullAddress(order.client.address)}</Typography>
                                        </Grid>
                                    </Box>
                                </Box>
                            </Grid>
                        ...
                        <Grid item container spacing={1} mt={"32px"}>
                            ...
                            <Grid item xs={12}>
                                <Box padding={0} margin={0}>
                                    ...
                                    <Box >
                                        <Grid item container alignItems={"center"} >
                                            <Typography fontFamily={"Inter"} color={"#45464E"} fontSize={"12px"} fontWeight={500} >{order.paymentType}</Typography>
                                        </Grid>
                                    </Box>
                                </Box>
                            </Grid>
